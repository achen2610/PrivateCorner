...
protocol DropdownControllerDelegate: class {
  func dropdownController(_ controller: DropdownController, didSelect album: GAlbum)
}
...
class DropdownController: UIViewController {
  ...
  func setup() {
    ...
    tableView.register(GAlbumCell.self, forCellReuseIdentifier: String(describing: GAlbumCell.self))
...
extension DropdownController: UITableViewDataSource, UITableViewDelegate {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    let cell = tableView.dequeueReusableCell(withIdentifier: String(describing: GAlbumCell.self), for: indexPath)
      as! GAlbumCell
