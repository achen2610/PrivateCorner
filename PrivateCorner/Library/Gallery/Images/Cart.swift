...
public protocol CartDelegate: class {
  func cart(_ cart: Cart, didAdd image: GImage, newlyTaken: Bool)
  func cart(_ cart: Cart, didRemove image: GImage)
...
public class Cart {
  ...
  public var images: [GImage] = []
  public var video: GVideo?
  ...
  public func add(_ image: GImage, newlyTaken: Bool = false) {
  ...
  public func remove(_ image: GImage) {
  ...
  public func reload(_ images: [GImage]) {
    self.images = images
