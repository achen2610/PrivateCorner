...
class CameraView: UIView, UIGestureRecognizerDelegate {
  ...
  func makeCloseButton() -> UIButton {
    ...
    button.setImage(GBundle.image("gallery_close"), for: UIControlState())
  ...
  func makeFlashButton() -> TripleButton {
    let states: [TripleButton.State] = [
      TripleButton.State(title: "Gallery.Camera.Flash.Off".g_localize(fallback: "OFF"), image: GBundle.image("gallery_camera_flash_off")!),
      TripleButton.State(title: "Gallery.Camera.Flash.On".g_localize(fallback: "ON"), image: GBundle.image("gallery_camera_flash_on")!),
      TripleButton.State(title: "Gallery.Camera.Flash.Auto".g_localize(fallback: "AUTO"), image: GBundle.image("gallery_camera_flash_auto")!)
    ]
  ...
  func makeRotateButton() -> UIButton {
    let button = UIButton(type: .custom)
    button.setImage(GBundle.image("gallery_camera_rotate"), for: UIControlState())
  ...
  func makeFocusImageView() -> UIImageView {
    ...
    view.image = GBundle.image("gallery_camera_focus")
